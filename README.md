...
This repository contains Pyronome **AdminLTE 3.x + React.js 16.x + Django 3.x** pattern basic information, pattern files, pattern templates, documentation and issue tracker. For further information about this pattern, please visit https://pyronome.com/pyronome/adminlte-3x-reactjs-16x-django-3x.
...
Please refer to the [Getting Started](https://github.com/pyronome/pattern-adminlte-3x-reactjs-16x-django-3x#getting-started) section for step by step instructions.
...
Please follow the steps below to generate source code using **AdminLTE 3.x + React.js 16.x + Django 3.x** pattern:
...
4. Please choose **AdminLTE 3.x + React.js 16.x + Django 3.x** pattern on Install Pattern(s) dialog.
...
Please use the [issue tracker](https://github.com/pyronome/pattern-adminlte-3x-reactjs-16x-django-3x/issues) to report any bugs/typos or requests.

## Versioning

We use [SemVer](http://semver.org/) for versioning. For the versions available, see releases section of the [pattern overview page](https://pyronome.com/pyronome/adminlte-3x-reactjs-16x-django-3x#Overview). 
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/pyronome/pattern-adminlte-3x-reactjs-16x-django-3x/blob/master/LICENSE) file for details
